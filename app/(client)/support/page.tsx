...
const MOCK_TICKETS = [
    {
        id: 'TKT-2025-0119-001',
        subject: 'Issue with E-Card Download',
        category: 'E-Card Problem',
        status: 'open',
        priority: 'high',
        createdAt: 'Jan 19, 2025',
        lastReply: '2 hours ago',
        lastMessage: "We're working on this. You'll receive your E-Card via email within 24 hours.",
        isFromSupport: true
    },
    {
        id: 'TKT-2025-0115-045',
        subject: 'Wallet Withdrawal Delay',
        category: 'Wallet/Payment Issue',
        status: 'resolved',
        priority: 'medium',
        createdAt: 'Jan 15, 2025',
        resolvedAt: 'Jan 17, 2025',
        resolution: 'Amount credited to your bank account.',
        isFromSupport: true
    },
    {
        id: 'TKT-2025-0110-012',
        subject: 'Coverage Query for Father',
        category: 'Plan/Coverage Question',
        status: 'resolved',
        priority: 'low',
        createdAt: 'Jan 10, 2025',
        resolvedAt: 'Jan 12, 2025',
        resolution: 'Coverage details shared via email.',
        isFromSupport: true
    }
];
...
export default function SupportPage() {
    ...
    const handleSubmitTicket = () => {
        ...
        toast.success('Ticket Submitted Successfully!', {
            description: `Ticket ID: TKT-2025-${Date.now().toString().slice(-7)}. We'll respond within 24 hours.`
        });
                    ...
                    {activeTab === 'tickets' && (
                        <div className="space-y-6">
                            <div className="flex items-center justify-between">
                                <h3 className="font-semibold text-slate-800">My Support Tickets ({MOCK_TICKETS.length})</h3>
                                <button
                                    onClick={() => setIsNewTicketOpen(true)}
                    ...
                    <div className="bg-white rounded-2xl shadow-xl w-full max-w-lg overflow-hidden animate-in fade-in zoom-in-95 duration-200 my-4">
                        ...
                        <div className="p-4 bg-slate-50 border-t border-slate-100 flex justify-end gap-2">
                            ...
                            <button
                                ...
                                className="px-6 py-2 text-sm font-medium bg-teal-600 text-white rounded-lg hover:bg-teal-700 transition-colors shadow-lg shadow-teal-200"
                            >
                                Submit Ticket
                            </button>
                        </div>
